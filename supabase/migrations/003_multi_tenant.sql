-- =============================================================================
-- 003_multi_tenant.sql — マルチテナント（SaaS 販売前提のスキーマ）
--
-- 責務:
--   - companies（plan, settings JSONB）で承認フロー・通知チャネル・インセンティブ方針
--   - expense_categories で経費カテゴリをテナント別に定義
--   - departments.company_id + incentive_enabled でインセンティブ対象部門を制御
--   - 主要テーブルへ company_id と RLS（auth_user_company_id()）
--
-- 既定テナント（レナード株式会社）:
--   id = 00000000-0000-0000-0000-000000000001
--   アプリの DEFAULT_COMPANY_ID（環境変数）と一致させること
--
