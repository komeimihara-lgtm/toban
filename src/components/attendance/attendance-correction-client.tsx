...
export function AttendanceCorrectionClient() {
  ...
  return (
    <div className="space-y-10">
      ...
      <form onSubmit={onSubmit} className="space-y-5 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/40">
        ...
        <div>
          ...
          <input
            ...
            required
            disabled={submitting}
            className="mt-1 w-full max-w-xs rounded-lg border border-zinc-300 bg-white px-3 py-2 text-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
          />
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-dashed border-zinc-300 bg-zinc-50/80 p-4 dark:border-zinc-600 dark:bg-zinc-950/50">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                disabled={submitting}
                className="mt-0.5 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
              />
            </div>
            <div>
              <label className="text-xs text-zinc-600 dark:text-zinc-400">
