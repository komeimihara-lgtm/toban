        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              type="submit"
              disabled={locked || pending}
              className="w-full rounded-xl bg-blue-600 px-6 py-2.5 font-medium text-white shadow-md transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {pending ? "送信中…" : "提出する"}
            </button>
          </div>
