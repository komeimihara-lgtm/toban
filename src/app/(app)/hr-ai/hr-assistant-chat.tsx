  ...
  return (
    <div className="mx-auto max-w-6xl">
      <header className="mb-6 border-b border-zinc-200 pb-4 dark:border-zinc-800">
        ...
        <p className="text-xs text-zinc-400">相談内容は上司に共有されません</p>
      </header>
          ...
          <div className="border-t border-zinc-200 p-3 dark:border-zinc-800">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="shrink-0 self-end rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-500 disabled:opacity-50"
              >
                送信
              </button>
            </div>
